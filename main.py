...
with col_hs13:
    st.write("<h5 style='text-align: justify; color: blue;'><a href = 'https://hargasaham-roa.streamlit.app/' target = '_blank'>Kumpulan Artikel (Jurnal & Prosiding): Pengaruh Return on Asset (ROA) terhadap Harga Saham</a><br><font color = 'red'>Artikel Terkumpul Sebanyak 20 Artikel</font></h5>", unsafe_allow_html=True)
